...
module.exports = {
    ...
    MessageHandler: function (event) {
        return new Promise(async function (resolve, reject) {
            ...
            if (keyword == null || keyword.length != 4) reject("輸入錯誤！指令格式：<keyword> -method <FullCompare(完全符合)|PartCompare(部分符合))> -response <response>，例如：1 2 3 -method FullCompare -response 4-5-6");
